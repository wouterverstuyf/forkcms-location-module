...
{form:add}
	...
	<div class="box horizontal">
		...
		<div class="options">
			...
			<p>
				<label for="city">{$lblFax|ucfirst}</label>
				{$txtFax} {$txtFaxError}
			</p>
			<p>
				<label for="city">{$lblTelephone|ucfirst}</label>
				{$txtTelephone} {$txtTelephoneError}
			</p>
			<p>
				<label for="city">{$lblEmail|ucfirst}</label>
				{$txtEmail} {$txtEmailError}
			</p>
			<p>
				<label for="organizationnumber">{$lblOrganizationnumber|ucfirst}</label>
				{$txtOrganizationnumber} {$txtOrganizationnumberError}
			</p>
		</div>
	</div>
