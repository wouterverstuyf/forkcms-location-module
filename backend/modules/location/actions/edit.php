...
class BackendLocationEdit extends BackendBaseActionEdit
{
	...
	private function loadForm()
	{
		...
		$this->frm->addText('organizationnumber', $this->record['organizationnumber']);
	...
	private function validateForm()
	{
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				$item['extra_organization_id'] = $this->record['extra_organization_id'];
				...
				$item['organizationnumber'] = $this->frm->getField('organizationnumber')->getValue();
